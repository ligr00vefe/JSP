            ...
            <table>
                ...
                <c:if test="${article.file == 1}">
	                ...
	                <tr>
	                    <td>첨부파일</td>
	                    <td>
	                        <a href="${article.fileBean.oldname}">2020년 상반기 매출자료.xls</a>
			...
			<script>
				...
				$(document).ready(function(){	
					...
					$btnSubmit.click(function(e){
						...
						// 태그 내용 채우기
						var $delHref = '/Jboard2/deleteComment.do?seq=${comment.seq}&parent=${comment.parent}';
						
						dom.find('.nick').text($nick);
						dom.find('.rdate').text($rdate);
						dom.find('textarea').text($comment);
						dom.find('.delComment').attr($delHref);						
