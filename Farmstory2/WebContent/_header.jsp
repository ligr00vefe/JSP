    ...
    <body>
        <div id="wrapper">
            <header>
                ...
                <img src="/Farmstory2/img/head_txt_img.png" alt="3만원이상 무료배송, 팜카드 10%">
                
                <ul class="gnb">
                    <li><a href="/Farmstory2/introduction/greeting.do">팜스토리소개</a></li>
                    <li><a href="/Farmstory2/board/list.do?group=market&cate=market"><img src="/Farmstory2/img/head_menu_badge.png">장보기</a></li>
