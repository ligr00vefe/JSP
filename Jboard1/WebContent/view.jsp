                ...
                <tr>
                 ...
                 <%
                 	if(article.getFile() == 1){ 
                                                                    	FileVO fBean = article.getFileBean();
                                                                    	session.setAttribute("fBean", fBean);
                 %>
                <tr>
                    <td>첨부파일</td>
                    <td>
                        <a href="/Jboard1/proc/procDownload.jsp?seq=<%=fBean.getSeq()%>%fname=<%=fBean.getOldName()%>"><%=fBean.getOldName()%></a>
            ...
            <section class="commentList">
                ...
                <article class="comment">
                    ...
                    <div>
                        ...
                        <a href="/Jboard1/proc/procDeleteComment.jsp?seq=<%= comment.getSeq() %>&parent=<%= article.getSeq() %>">삭제</a>
                        <a href="#">수정</a>
                        <% } %>
                    </div>
                </article>
