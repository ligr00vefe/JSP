        ...
        <div id="wrapper">
            <header>
                ...
                <p>
                    ...
                    <% }else { %>
                    	<a href="/Farmstory1/user/proc/procLogout.jsp">로그아웃</a>
                    <% } %>
                    <a href="#">고객센터</a>
                </p>
                <img src="/Farmstory1/img/head_txt_img.png" alt="3만원이상 무료배송, 팜카드 10%">
                
                <ul class="gnb">
                    <li><a href="/Farmstory1/introduction/greeting.jsp">팜스토리소개</a></li>
                    <li><a href="/Farmstory1/board/list.jsp?group=market&cate=market"><img src="/Farmstory1/img/head_menu_badge.png">장보기</a></li>
